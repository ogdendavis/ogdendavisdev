    ...
    <WorkSection>
      <ContentContainer>
        ...
        <ul>
          ...
          <li>
            Implement features quickly and iteratively in an agile workflow
          </li>
          <li>
            Work in both front-end (React) and back-end (Node.js/GCP)
            environments
          </li>
          <li>Refactor legacy code, manage tech debt, and maintain packages</li>
        </ul>
        <p>
          Before I worked at Beepboop, I was (at various points) a web
          development contractor for a marketing and PR firm, a freelance web
          developer, a computer science teacher, and a gym owner and manager. If
          you want the full rundown, you can check out my{" "}
